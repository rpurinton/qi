...
<div class="discroller">
    <div class="form-check form-switch control-group">
        <div class="row">
            <div class="col-auto" style='display: flex; align-items: center;'>
                <label class="form-check-label" for="privacy-toggle" style='font-size:125%; font-weight:bold;'>Private</label>
            </div>
            <div class="col" style='display: flex; align-items: center;'>
                <input class="form-check-input" type="checkbox" id="privacy-toggle" name="privacy-toggle">
            </div>
            <div class="col-auto" style='display: flex; align-items: center;'>
                <label id="public-label" class="form-check-label" for="privacy-toggle" style='font-size:125%; font-weight:bold;'>Public</label>
            </div>
    ...
    <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
        <label for="attachments" style="font-size: 125%; font-weight: bold;"><i class="mdi mdi-arrow-up-bold-circle-outline" style='font-size: 150%; vertical-align:middle;'></i> Drag files here to upload attachments<i class='mdi mdi-arrow-up-bold-circle-outline' style='font-size: 150%; vertical-align: middle;'></i></label>
    </div>
