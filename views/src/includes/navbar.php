...
<nav class="navbar p-0 fixed-top d-flex flex-row flex-nowrap" style="vertical-align: middle;">
  <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
    ...
    <a class="navbar-brand brand-logo-mini" style="padding: 0;" href="/favorites"><img style='margin-left: 15px; margin-right:10px; width: 25px; height: 25px;  vertical-align: text-top;' src='/assets/images/icon/qi_icon.png'></a>
  </div>
